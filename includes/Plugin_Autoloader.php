<?php
/**
 * Class Felix_Arntz\WP_AI_SDK_Chatbot_Demo\Plugin_Autoloader
 *
 * @since 0.1.0
	...
	public function __construct( string $root_ns, string $class_map_file ) {
		...
		if ( ! is_array( $this->class_map ) ) {
			throw new InvalidArgumentException(
				esc_html__( 'The provided class map file does not return a class map array.', 'wp-ai-sdk-chatbot-demo' )
			);
		}
	}
