...
- In order to change which provider is used, the site administrator can update the settings within WP Admin at: options-general.php?page=wpaisdk-chatbot-demo-settings
